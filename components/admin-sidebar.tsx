...
export function AdminSidebar() {
    ...
    return (
        <>
            {/* Mobile top bar */}
            <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-950/90 via-black/80 to-purple-950/90 backdrop-blur-xl border-b border-purple-500/20 flex items-center justify-between px-4 py-3">
                <h1 className="text-sm font-bold bg-gradient-to-r from-purple-300 to-purple-500 bg-clip-text text-transparent">
                    KripikWasyif Admin
                </h1>
                <button
            ...
            {/* Mobile drawer */}
            <aside className={`lg:hidden fixed top-0 left-0 bottom-0 w-64 z-50 transform transition-transform duration-300 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
